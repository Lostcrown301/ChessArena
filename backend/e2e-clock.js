...
async function runTest() {
  ...
  console.log(
    `12. Reconnected game timers restored. White: ${reconnectedGame.whiteRemainingMs}, Black: ${reconnectedGame.blackRemainingMs}`,
  );
  if (!reconnectedGame.timerStartedAt) throw new Error('Reconnection lost timer state');

  // 15, 16. Timeout test
  console.log(
    '15. Allowing White timer to expire (simulating claim timeout instead of waiting 10 mins)...',
  );
